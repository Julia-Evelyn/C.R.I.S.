class DadosClasse {
  ...
  DadosClasse(this.pvBase, this.peBase, this.sanBase, this.pvPorNivel, this.pePorNivel, this.sanPorNivel);
}

class DadosOrigem {
  final String nome, nomeHabilidade, descHabilidade;
  final List<String> pericias;
  DadosOrigem(this.nome, this.pericias, this.nomeHabilidade, this.descHabilidade);
}
...
final Map<String, DadosOrigem> dadosOrigens = {
  ...
  'profetizado': DadosOrigem(
    "Profetizado",
    ["vontade", "pericia_extra"], // Como "pericia_extra" é genérica, ela servirá como marcação.
    "Luta ou Fuga",
